CREATE OR REPLACE PACKAGE  stpks_stdkevi3_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdkevi3_main.spc
  **
...
TYPE ty_tb_v_detail_stdkevi3 IS TABLE OF detail_stdkevi3%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdkevi3 IS RECORD (
     v_master_stdkevi3     master_stdkevi3%ROWTYPE,
     v_detail_stdkevi3    ty_tb_v_detail_stdkevi3,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdkevi3_main FOR stpks_stdkevi3_main
/