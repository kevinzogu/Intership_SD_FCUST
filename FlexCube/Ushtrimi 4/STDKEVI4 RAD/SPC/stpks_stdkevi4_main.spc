CREATE OR REPLACE PACKAGE  stpks_stdkevi4_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdkevi4_main.spc
  **
...
TYPE ty_tb_v_detail_stdkevi4 IS TABLE OF detail_stdkevi4%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdkevi4 IS RECORD (
     v_master_stdkevi4     master_stdkevi4%ROWTYPE,
     v_detail_stdkevi4    ty_tb_v_detail_stdkevi4,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdkevi4_main FOR stpks_stdkevi4_main
/