CREATE OR REPLACE PACKAGE  stpks_stdkevi2_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdkevi2_main.spc
  **
...
TYPE ty_tb_v_detail_stdkevi2 IS TABLE OF detail_stdkevi2%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdkevi2 IS RECORD (
     v_master_stdkevi2     master_stdkevi2%ROWTYPE,
     v_detail_stdkevi2    ty_tb_v_detail_stdkevi2,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdkevi2_main FOR stpks_stdkevi2_main
/