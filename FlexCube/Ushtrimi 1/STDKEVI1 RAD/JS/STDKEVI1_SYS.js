...
var queryFields = new Array();    //Values should be set inside STDKEVI1.js, in "BlockName__FieldName" format
var pkFields    = new Array();    //Values should be set inside STDKEVI1.js, in "BlockName__FieldName" format
queryFields[0] = "BLK_MAIN__GROUP_CODE";
pkFields[0] = "BLK_MAIN__GROUP_CODE";
//----------------------------------------------------------------------------------------------------------------------
//***** CODE FOR AMENDABLE/SUBSYSTEM Fields *****
//----------------------------------------------------------------------------------------------------------------------
//***** Fields Amendable while Modification *****
var modifyAmendArr = {"BLK_MAIN":["EXPOSURE_CATEGORY","GROUP_STATUS","GROUP_TYPE","SINCEI","TAB_DESCRIPTION"]};
...
ArrFuncOrigin["STDKEVI1"]="CUSTOM";
ArrPrntFunc["STDKEVI1"]="";
ArrPrntOrigin["STDKEVI1"]="";
ArrRoutingType["STDKEVI1"]="X";


 // Code for Loading Cluster/Custom js File Starts
ArrClusterModified["STDKEVI1"]="N";
ArrCustomModified["STDKEVI1"]="Y";
