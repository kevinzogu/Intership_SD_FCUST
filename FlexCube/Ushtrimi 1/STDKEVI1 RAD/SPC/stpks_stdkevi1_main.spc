CREATE OR REPLACE PACKAGE  stpks_stdkevi1_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdkevi1_main.spc
  **
...
TYPE ty_stdkevi1 IS RECORD (
     v_tab_stdkevi1     tab_stdkevi1%ROWTYPE,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdkevi1_main FOR stpks_stdkevi1_main
/